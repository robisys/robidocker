...
#docker run -it  --rm --volume  weba-app-data:/mnt  --name  wruna -h HOSTa robidock/opensuse /bin/bash
#docker run -it  --rm --volume  webb-app-data:/mnt  --name  wrunb -h HOSTb robidock/opensuse /bin/bash
